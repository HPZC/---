...
window.addEventListener('scroll', function () {
  ...
  text1.style.top = value * -1.5 + 'px'
  text1.style.left = value * -5 + 'px'
  text2.style.top = value * -1.5 + 'px'
  text2.style.left = value * 2 + 'px'
  text3.style.marginTop = value / 3 + 'px'
  text4.style.top = value * -0.12 + 'px'
  tetx5.style.top = value * 0.25 + 'px'
...
function App() {
  ...
  return (
    ...
    <div className="bg-[#49d9d7] text-white overflow-hidden flex flex-col">
      <div className="flex  w-full h-screen">
        <div className="relative w-full flex justify-center items-center">

          <img id="text2" className="z-10000 absolute " src={bird1} />
          <img id="text1" className="z-10000 absolute" src={bird2} />

          <div id="text" className=" flex flex-col absolute  items-center  text-blue-800 text-center ">

            <div className=" text-2xl">It's time for searching a </div>
            <div className="font-[Rancho] text-9xl font-bold"> Quote</div>

          </div>
          <button id="text3" data-tip="Intoduce: This website has parralax animation and the random quote function" className="tooltip translate-y-40 absolute z-10000 rounded-full w-52 py-2 bg-red-200 text-lg font-semibold">Hover Me !</button>
          <img className="pt-32 absolute  w-full" src={forest} id="text5" />
          <img className="absolute" src={rocks} id="text4" />
          <img className="absolute " src={water} id="water" />

        </div>

      </div>
      <div className="flex flex-col justify-center items-center  w-full bg-[#0da1a8] text-white p-20">
        <div className="text-lg font-bold h-12"> {pickRandom( [
        ...
        <Icon className="hover:cursor-pointer w-8 h-8" onClick={refreshPage} icon="ph:arrow-counter-clockwise-thin" />
       
      </div>
      <div className="text-white justify-center flex items-center bg-[#178578] w-full h-10">
        Copyright (C) 2022 HPZC; All rights reserved;
      </div>
    </div>
